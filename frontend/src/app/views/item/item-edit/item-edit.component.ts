...
export class ItemEditComponent implements OnInit {
  ...
  validate() {
    ...
    if (this.editItemData.geoCity.trim() === '' ) {
      return;
    }
    if (this.editItemData.details.trim() === '' ) {
      return;
    }
    if (this.editItemData.about.trim() === '' ) {
      return;
    }
  ...
  closeModal() {
    // const el: HTMLElement = this.closeModal_view.nativeElement as HTMLElement;
    // el.click();
